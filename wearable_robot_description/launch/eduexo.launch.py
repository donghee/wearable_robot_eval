...
def generate_launch_description():
    ...
    default_model_path = pkg_wearable_robot_path / 'urdf/eduexo.xacro'
    ...
    return LaunchDescription([
        ...
        Node(package='wearable_robot_description', executable='spawn_entity.py', arguments=['eduexo', robot_desc], output='screen'),
        Node(
