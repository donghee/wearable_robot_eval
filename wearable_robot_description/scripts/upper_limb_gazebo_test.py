...
class OneDofArmActionClient(Node):
    ...
    def __init__(self):
        super().__init__('upper_limb_arm_actionclient')
        self.goal_order = 0
        ...
        self._action_client = ActionClient(self, FollowJointTrajectory, '/upper_limb_joint_controller/follow_joint_trajectory')
